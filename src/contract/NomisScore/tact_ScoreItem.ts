...
function dictValueParserCollectionData(): DictionaryValue<CollectionData> {
 ...
 type ScoreItem_init_args = {
    $$type: 'ScoreItem_init_args';
    collection: Address;
    index: bigint;
}

function initScoreItem_init_args(src: ScoreItem_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.collection);
        b_0.storeInt(src.index, 257);
...
async function ScoreItem_init(collection: Address, index: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initScoreItem_init_args({ $$type: 'ScoreItem_init_args', collection, index })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const ScoreItem_errors: { [key: number]: { message: string } } = {
...
const ScoreItem_getters: ABIGetter[] = [
...
const ScoreItem_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SetScore"}},
    {"receiver":"internal","message":{"kind":"typed","type":"NftTransfer"}},
    {"receiver":"internal","message":{"kind":"typed","type":"NftGetStaticData"}},
]

export class ScoreItem implements Contract {

    static async init(collection: Address, index: bigint) {
        return await ScoreItem_init(collection, index);
    }

    static async fromInit(collection: Address, index: bigint) {
        const init = await ScoreItem_init(collection, index);
        const address = contractAddress(0, init);
        return new ScoreItem(address, init);
    }

    static fromAddress(address: Address) {
        return new ScoreItem(address);
    }

    readonly address: Address;
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ScoreItem_types,
        getters: ScoreItem_getters,
        receivers: ScoreItem_receivers,
        errors: ScoreItem_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SetScore | NftTransfer | NftGetStaticData) {

        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetScore') {
            body = beginCell().store(storeSetScore(message)).endCell();
        }
